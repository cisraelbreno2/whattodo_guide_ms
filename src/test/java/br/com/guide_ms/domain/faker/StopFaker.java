...
public class StopFaker {
    ...
    public static GuideStopRegister createGuideStopRegister(){
        return new GuideStopRegister("Restaurante", "123415; 1616161", "Comer", CategoryLocacion.FOOD, LocalDateTime.now(), LocalDateTime.now(), null);
    }
}
